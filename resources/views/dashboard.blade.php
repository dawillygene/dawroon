...
<x-card.card>
    ...
    <x-table.table>
        <x-slot name="header">
            <tr>
                <x-table.table-cell class="text-xs font-medium text-default-600 uppercase">Product</x-table.table-cell>
                <x-table.table-cell class="text-xs font-medium text-default-600 uppercase">Sales</x-table.table-cell>
                <x-table.table-cell class="text-xs font-medium text-default-600 uppercase">Change</x-table.table-cell>
                <x-table.table-cell class="text-xs font-medium text-default-600 uppercase">Profit</x-table.table-cell>
            </tr>
        </x-slot>

        <x-slot name="body">
            <x-table.table-row>
                <x-table.table-cell class="text-sm font-medium text-default-900">Nuts & Berries</x-table.table-cell>
...
<x-table.table-container>
    ...
    <x-table.table>
        <x-slot name="header">
            <tr>
                <x-table.table-cell class="text-xs font-medium text-default-600 uppercase">Order Number</x-table.table-cell>
                <x-table.table-cell class="text-xs font-medium text-default-600 uppercase">Product Name</x-table.table-cell>
                <x-table.table-cell class="text-xs font-medium text-default-600 uppercase">Order Date</x-table.table-cell>
                <x-table.table-cell class="text-xs font-medium text-default-600 uppercase">Price</x-table.table-cell>
                <x-table.table-cell class="text-center text-xs font-medium text-default-600 uppercase">Action</x-table.table-cell>
            </tr>
        </x-slot>
        ...
        <x-slot name="body">
            <x-table.table-row>
                ...
                <x-table.table-cell class="text-sm font-medium text-default-800">Nuts And Berries</x-table.table-cell>
